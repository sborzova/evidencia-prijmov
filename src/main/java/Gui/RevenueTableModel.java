...
public class RevenueTableModel extends AbstractTableModel {
    ...
    public RevenueTableModel(RevenueManager revenueManager, EmployeeManager employeeManager) {
        ...
        readAllSwingWorker = new ReadAllSwingWorker(revenueManager, employeeManager);
    ...
    private class ReadAllSwingWorker extends SwingWorker<List<Revenue>, Void> {
        ...
        public ReadAllSwingWorker(RevenueManager revenueManager) {
            this.revenueManager = revenueManager;
        }
    ...
    private class AddSwingWorker extends SwingWorker<Void, Void> {
        ...
        public AddSwingWorker(RevenueManager revenueManager, Revenue revenue) {
            this.revenueManager = revenueManager;
    ...
    private class DeleteSwingWorker extends SwingWorker <Void, Void> {
        ...
        public DeleteSwingWorker(RevenueManager revenueManager, int rowIndex) {
            this.revenueManager = revenueManager;
            this.row = rowIndex;
        }
        ...
        @Override
        protected Void doInBackground() throws Exception {
            revenueManager.deleteRevenue(revenueManager.getRevenue((Long) getValueAt(row, 0)));
            return null;
        }
    ...
    private class ListSwingWorker extends SwingWorker<List<Revenue>, Void> {
        ...
        public ListSwingWorker(RevenueManager revenueManager, LocalDate from, LocalDate to) {
            this.revenueManager = revenueManager;
            this.from = from;
            this.to = to;
        }
        ...
        @Override
        protected List<Revenue> doInBackground() throws Exception {
            return revenueManager.listRevenuesByMonth(from, to);
        }
    ...
    void deleteRow(int row) {
        DeleteSwingWorker deleteSwingWorker = new DeleteSwingWorker(revenueManager, row);
        deleteSwingWorker.execute();
    }

    void findRows(int row) {
        FindSwingWorker findSwingWorker = new FindSwingWorker(revenueManager, employeeManager, row);
        findSwingWorker.execute();
    }

    void listRows(LocalDate from, LocalDate to) {
        ListSwingWorker listSwingWorker = new ListSwingWorker(revenueManager, from, to);
